...
class ReferenceValidatorTest {
    ...
    fun `validates text and paragraph style refs`() {
        textStyleRepo.upsert(aTextStyle("text1", targetId = "textref1"))
        textStyleRepo.upsert(aTextStyle("textref1", targetId = "textref2"))
        textStyleRepo.upsert(aTextStyle("textref2"))
        paraStyleRepo.upsert(aParagraphStyle("para1", targetId = "pararef1"))
        paraStyleRepo.upsert(aParagraphStyle("pararef1", targetId = "pararef2"))
