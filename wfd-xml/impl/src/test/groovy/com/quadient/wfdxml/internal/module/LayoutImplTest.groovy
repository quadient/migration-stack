...
class LayoutImplTest extends Specification {
    ...
    def "variable with existing parent id uses in its forward reference export"() {
        ...
        then:
        assert result.contains("<Variable><Id>SR_31</Id><Name>MyVar</Name><ParentId>Data.Clients.Value</ParentId><Forward useExisting=\"True\"></Forward></Variable>")
        assert result.contains("<Variable><Id>SR_31</Id><Type>Disconnected</Type><VarType>Int</VarType><Content>0</Content></Variable>")
    }
