...
for (obj in allObjects) {
    docObjWithRefsCache.put(obj.id, new DocObjAndRefs(obj, migration.referenceCollector.collectAllRefs(obj) { true }))
}
...
class DocObjAndRefs {
    ...
    DocObjAndRefs(DocumentObject obj, Set<Ref> refs) {
        this.obj = obj
        this.refs = refs
    }
}
